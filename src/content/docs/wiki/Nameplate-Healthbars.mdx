---
title: Nameplate healthbars
description: Nameplates can also be health bars now You can also select Stay active when you do Ctrl + Shift if you want them up all the time Settings image Enable this under Options->General->Mobiles where you can also adjust the opacity of the background.
---
