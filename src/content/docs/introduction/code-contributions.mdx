...
Welcome to TazUO! We appreciate your interest in contributing to our custom Ultima Online client. TazUO is a C# FNA-based game, originally forked from ClassicUO but now maintained as an independent project focused on quality-of-life improvements for players.
...
- **`dev`** - Target this branch for .NET 10 code contributions (actively maintained)
- **`main`** - **DO NOT TARGET** - This is the stable release branch

### Development Focus

- **Primary Development**: Most active development happens on the `.NET 10` version (`dev` branch)
...
- Basic understanding of C# and the FNA framework
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/xxYOUR_USERNAMExx/TazUO.git
   cd TazUO
   ```
...
2. Create a Pull Request against the appropriate upstream branch:
   ...
   - **For .NET 10 features**: Target `dev` branch
...
- **Feature Requests**: Join our Discord or use [Forums](https://forums.tazuo.org) to propose new features
- **Wiki Updates**: Check our wiki here for existing feature documentation
...
- ✅ **legacy** - .NET Framework 4.7.2
- ✅ **dev** - .NET 10 development  
